...
def parse_arguments():
    ...
    parser.add_argument('--date', type=str, required=True, help='Date argument (YYYY-MM-DD)')
    parser.add_argument('--time', type=str, required=True, help='Time argument (HH:MM:SS)')
